    ...
    <div className="bg-background flex min-h-screen w-full items-center justify-center px-4">
      ...
      <Card className="z-10 w-full max-w-md border-white/10 bg-black/40 backdrop-blur-xl">
        <CardHeader className="space-y-1 text-center">
          <div className="bg-primary text-primary-foreground mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl shadow-[0_0_20px_rgba(239,68,68,0.5)]">
